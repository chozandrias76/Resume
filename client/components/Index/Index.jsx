  ...
  render() {
    ...
    return (
      <div>
        ...
        <div id="front">
          <div crossOrigin className="layer-bg layer" data-depth={0.0} data-type="parallax"><canvas/></div>
          ...
          <div crossOrigin className="layer-3 layer" data-depth="0.30" data-type="parallax"/>
