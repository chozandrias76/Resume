          ...
          <div className="row">
              ...
              <div className="profile-widget">
                ...
                <div className="widget-social" lv45phk="" hidden="">
                  ...
                  <a href="https://www.facebook.com/swensonhealeyc" target="_blank">
                    <i className="fa fa-facebook btn btn-round btn-clear btn-facebook" />
                  </a>

                  <a href="https://github.com/chozandrias76/" target="_blank">
                    <i className="fa fa-github-alt btn btn-round btn-clear btn-github" />
                  </a>

                  <a href="https://twitter.com/xenos76" target="_blank">
                    <i className="fa fa-twitter btn btn-round btn-clear btn-twitter" />
                  </a>

                  <a href="https://plus.google.com/u/0/116426537740453446298" target="_blank">
                    <i className="fa fa-google-plus btn btn-round btn-clear btn-google" />
                  </a>
            ...
            >
              ...
              <p>I am a graduate from The Art Institute of Seattle, and I am a problem solver
                at heart. I enjoy solving design, programming, and engineering problems alike.
              </p>
              <p>I am most interested in technology because of the unique ways it is
                ...
                adapting technology in new ways to enrich our daily experiences.
              </p>
            </div>
